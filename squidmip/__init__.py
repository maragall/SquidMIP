...
The public surface is intentionally tiny::
    ...
    reader = open_reader("/path/to/acquisition")   # individual TIFF, OME-TIFF or HCS zarr
...
from squidmip.reader import SquidOMEReader, SquidReader, SquidZarrReader, open_reader
